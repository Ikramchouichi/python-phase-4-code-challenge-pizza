...
Revision ID: cfe8dad29168
Revises: 
Create Date: 2024-03-19 00:15:39.864464
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['pizza_id'], ['pizzas.id'], name=op.f('fk_restaurants_pizza_id_pizzas'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['restaurant_id'], ['restaurants.id'], name=op.f('fk_restaurants_restaurant_id_restaurants'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
